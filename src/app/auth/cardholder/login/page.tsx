  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/auth/login', {
        ...
        body: JSON.stringify({ email, password, role: 'cardholder' }),
      });
      ...
      toast({ 
        title: 'Welcome back!', 
        description: 'Successfully logged in as Cardholder' 
      });
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-background p-4 animate-fade-in">
      ...
      <Card className="w-full max-w-md shadow-2xl animate-slide-up">
        <CardHeader className="text-center">
          ...
          <CardTitle className="font-headline text-3xl text-accent">Cardholder Login</CardTitle>
          <CardDescription className="text-base">
            Access your ration card and book tokens
          </CardDescription>
        </CardHeader>
        <CardContent>
